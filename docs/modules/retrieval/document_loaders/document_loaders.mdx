...
description: Load data from various sources as Documents with text and metadata
previous: /modules/retrieval/retrieval
previousTitle: Retrieval
next: /modules/retrieval/document_loaders/how_to/csv
nextTitle: CSV Loader
---
