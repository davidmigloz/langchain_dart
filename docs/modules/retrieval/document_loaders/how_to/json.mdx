...
previous: /modules/retrieval/document_loaders/how_to/directory
previousTitle: Directory Loader
next: /modules/retrieval/document_loaders/how_to/text
nextTitle: Text Loader
---
