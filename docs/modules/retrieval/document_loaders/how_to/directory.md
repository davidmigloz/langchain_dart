...
- Throws an `ArgumentError` if the specified directory does not exist
- Throws an assertion error if the sample size is larger than the total number of files
