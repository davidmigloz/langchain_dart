...
previous: /modules/retrieval/document_transformers/text_splitters/code_splitter
previousTitle: Code Splitter
next: /modules/retrieval/text_embedding/integrations/openai
nextTitle: OpenAI Embeddings
---
