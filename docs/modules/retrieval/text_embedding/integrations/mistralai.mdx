...
description: Generate embeddings using Mistral AI's embedding models
previous: /modules/retrieval/text_embedding/integrations/gcp_vertex_ai
previousTitle: Vertex AI Embeddings
next: /modules/retrieval/vector_stores
nextTitle: Vector Stores
---
