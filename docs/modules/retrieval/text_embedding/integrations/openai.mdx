...
previous: /modules/retrieval/text_embedding
previousTitle: Text Embedding Models
next: /modules/retrieval/text_embedding/integrations/ollama
nextTitle: Ollama Embeddings
---
