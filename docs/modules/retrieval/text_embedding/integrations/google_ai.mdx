---
title: Google AI Embeddings
description: Generate embeddings using Gemini API's state-of-the-art models
previous: /modules/retrieval/text_embedding/integrations/ollama
previousTitle: Ollama Embeddings
next: /modules/retrieval/text_embedding/integrations/gcp_vertex_ai
nextTitle: Vertex AI Embeddings
---
