---
title: Pinecone
description: Cloud-hosted vector database for similarity search
previous: /modules/retrieval/vector_stores/integrations/objectbox
previousTitle: ObjectBox
next: /modules/retrieval/vector_stores/integrations/supabase
nextTitle: Supabase
---
