---
title: ObjectBox
description: On-device vector database with HNSW algorithm for Flutter and Dart
previous: /modules/retrieval/vector_stores/integrations/memory
previousTitle: Memory Vector Store
next: /modules/retrieval/vector_stores/integrations/pinecone
nextTitle: Pinecone
---
