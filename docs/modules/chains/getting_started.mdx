...
previous: /modules/chains/chains
previousTitle: Chains
next: /modules/chains/how_to/call_methods
nextTitle: Call Methods
---
...
method. You can learn more about it in [Memory](/modules/memory/memory) section.
