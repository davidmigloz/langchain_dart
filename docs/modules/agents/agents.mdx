---
title: Agents
description: Flexible chains that use LLMs to determine which tools to use based on user input
previous: /modules/memory/memory
previousTitle: Memory
next: /modules/agents/agent_types/agent_types
nextTitle: Agent Types
---
...
[agent types](/modules/agents/agent_types/agent_types). Additional
