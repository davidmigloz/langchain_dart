---
title: Agent Types
description: Overview of different agent types including action and plan-and-execute agents
previous: /modules/agents/agents
previousTitle: Agents
next: /modules/agents/agent_types/tools_agent
nextTitle: Tools Agent
---
...
[More info...](./openai_functions_agent)
