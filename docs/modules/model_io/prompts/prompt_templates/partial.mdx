...
description: Create partial prompts by passing a subset of required values upfront
previous: /modules/model_io/prompts/prompt_templates/msg_prompt_templates
previousTitle: Message Prompt Templates
next: /modules/model_io/prompts/prompt_templates/prompt_composition
nextTitle: Composition
---
