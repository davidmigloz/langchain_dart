...
description: Create custom prompt templates for specific dynamic instructions
previous: /modules/model_io/prompts/prompt_templates/prompt_templates
previousTitle: Prompt Templates
next: /modules/model_io/prompts/prompt_templates/few_shot_examples
nextTitle: Few Shot Examples
---
...
templates [here](/modules/model_io/prompts/prompt_templates/prompt_templates).
