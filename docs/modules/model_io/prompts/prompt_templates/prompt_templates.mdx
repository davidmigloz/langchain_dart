...
description: Create reproducible prompts with templates, input variables, and formatting
previous: /modules/model_io/prompts/prompts
previousTitle: Prompts
next: /modules/model_io/prompts/prompt_templates/custom_prompt_template
nextTitle: Custom Prompt Templates
---
...
[Chat Models](/modules/model_io/models/chat_models/chat_models) take a list 
