...
previous: /modules/model_io/prompts/prompt_templates/prompt_serialization
previousTitle: Serialization
next: /modules/model_io/prompts/example_selectors
nextTitle: Example Selectors
---
