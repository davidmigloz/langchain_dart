---
title: LLMChain (Deprecated)
description: Use LLMChain with chat models (deprecated in favor of LCEL)
---
...
[with LLMs](/modules/chains#get-started) - provide a prompt and a 
model.
