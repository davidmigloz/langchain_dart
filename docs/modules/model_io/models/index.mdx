...
description: LLMs and Chat Models for text generation
---
...
- [LLMs](/modules/model_io/models/llms): Models that take a text string
  as input and return a text string.
- [Chat models](/modules/model_io/models/chat_models): Models
