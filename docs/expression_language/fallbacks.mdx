---
title: Fallbacks
description: Handle LLM API errors gracefully with configurable fallback chains
previous: /expression_language/streaming
previousTitle: Streaming
next: /expression_language/cookbook/prompt_llm_parser
nextTitle: "Prompt + LLM"
---
