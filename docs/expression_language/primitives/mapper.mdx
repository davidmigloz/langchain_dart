---
title: "Mapper: Mapping Input Values"
description: Transform and map output values to conform to next runnable's input requirements
previous: /expression_language/primitives/passthrough
previousTitle: Passthrough
next: /expression_language/primitives/function
nextTitle: Function
---
