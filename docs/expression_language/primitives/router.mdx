---
title: "Router: Routing Inputs"
description: Dynamically route logic based on input using RunnableRouter
previous: /expression_language/primitives/binding
previousTitle: Binding
next: /expression_language/primitives/retry
nextTitle: Retry
---
