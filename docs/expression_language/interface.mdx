...
description: The standard interface for invoking, streaming, and batching LangChain components
previous: /expression_language/get_started
previousTitle: Get Started
next: /expression_language/primitives
nextTitle: Primitives Overview
---
