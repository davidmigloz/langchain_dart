...
| [ChatOllamaTools](https://langchaindart.dev/#/modules/model_io/models/chat_models/integrations/ollama_tools)            | [langchain_ollama](https://pub.dev/packages/langchain_ollama)       |           | ✔           | ✔         | [Ollama Chat API](https://ollama.ai) with tool-calling capabilities                                                                                                                                                                                                                                                                                                                                                                          |
