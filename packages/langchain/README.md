...
- 🤖 **Agents:** "bots" that leverage LLMs to make informed decisions about which available tools (such us web search, calculators, database lookup, etc.) to use to accomplish the designated task.
