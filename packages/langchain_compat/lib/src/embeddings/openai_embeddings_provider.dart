...
class OpenAIEmbeddingsProvider implements EmbeddingsProvider {
  /// Create a new [OpenAIEmbeddingsProvider] instance.
  ///
  ...
  /// - [OpenAIEmbeddingsProvider.model]
  /// - [OpenAIEmbeddingsProvider.dimensions]
  /// - [OpenAIEmbeddingsProvider.batchSize]
  /// - [OpenAIEmbeddingsProvider.user]
  ///
