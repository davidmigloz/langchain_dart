...
/// - `mistral-tiny`: Mistral 7B Instruct v0.2 (a minor release of Mistral 7B
///    Instruct). It only works in English and obtains 7.6 on MT-Bench.
/// - `mistral-small`: Mixtral 8x7B. It masters
///    English/French/Italian/German/Spanish and code and obtains 8.3 on
///    MT-Bench.
/// - `mistral-medium`: a prototype model, that is currently among the top
///    serviced models available based on standard benchmarks. It masters
///    English/French/Italian/German/Spanish and code and obtains a score of 8.6
///    on MT-Bench.
///
/// Mind that this list may not be up-to-date. Refer to the
/// [documentation](https://docs.mistral.ai/models) for the updated list.
///
/// ### Call options
///
...
///   'q1': prompt1 |
///       chatModel.bind(const ChatMistralAIOptions(model: 'mistral-tiny')) |
///       outputParser,
///   'q2': prompt2 |
///       chatModel.bind(const ChatMistralAIOptions(model: 'mistral-medium')) |
///       outputParser,
/// });
...
class ChatMistralAI extends BaseChatModel<ChatMistralAIOptions> {
  ...
  ///
  /// Currently Mistral AI does not provide a tokenizer for the models it
  ...
  /// from the ones used by the Ollama model.
  ///
