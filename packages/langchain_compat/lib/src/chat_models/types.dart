...
sealed class ChatMessage {
  ...
  /// Converts this ChatMessage to a map along with a type hint for
  /// deserialization.
...
class ChatMessageContentText extends ChatMessageContent {
  ...
  @override
  /// Converts this ChatMessageContent to a map along with a type hint for
  /// deserialization.
  Map<String, dynamic> toMap() => {
    ...super.toMap(),
    'type': 'text',
...
class ChatMessageContentMultiModal extends ChatMessageContent {
  ...
  /// Converts [ChatMessageContentMultiModal] to a map along with a type hint
  /// for deserialization.
  @override
  Map<String, dynamic> toMap() => {
    ...super.toMap(),
...
sealed class ChatToolChoice {
  ...
  /// The model must call at least one tool, but doesn't force a particular
  /// tool.
  static const required = ChatToolChoiceRequired();

  /// Converts this ChatToolChoice to a map along with a type hint for
  /// deserialization.
  Map<String, dynamic> toMap() => {};
}
