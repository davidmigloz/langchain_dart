...
/// ### Authentication
///
/// The Anthropic API uses API keys for authentication. Visit your [API
/// Keys](https://console.anthropic.com/settings/keys) page to retrieve the API
...
/// - `claude-2.1`
///
/// Mind that the list may not be up-to-date. See
/// https://docs.anthropic.com/en/docs/about-claude/models for the updated list.
///
/// ### Call options
///
