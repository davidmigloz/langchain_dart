...
class _$GenerateChatCompletionRequestImpl
  ...
  @override
  String toString() {
    return 'GenerateChatCompletionRequest(model: $model, messages: $messages, format: $format, options: $options, template: $template, stream: $stream)';
  }
...
class _$GenerateChatCompletionResponseImpl
  ...
  @override
  String toString() {
    return 'GenerateChatCompletionResponse(message: $message, model: $model, createdAt: $createdAt, done: $done, sampleCount: $sampleCount, sampleDuration: $sampleDuration, totalDuration: $totalDuration, loadDuration: $loadDuration, promptEvalCount: $promptEvalCount, promptEvalDuration: $promptEvalDuration, evalCount: $evalCount, evalDuration: $evalDuration)';
  }
