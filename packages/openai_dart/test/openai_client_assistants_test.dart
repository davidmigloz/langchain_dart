  ...
  group(
    ...
    () {
      ...
      Future<void> checkThreadRunSteps(
        ...
        final details = step1.stepDetails.mapOrNull(
          messageCreation: (final d) => d.messageCreation,
        );
        ...
        final toolCalls = step2.stepDetails.mapOrNull(
          toolCalls: (final d) => d.toolCalls,
        );
        ...
        final details3 = step3.stepDetails.mapOrNull(
          messageCreation: (final d) => d.messageCreation,
        );
          ...
          final res = await client.createThreadMessage(
            ...
            request: const CreateMessageRequest(
              ...
              content: CreateMessageRequestContent.parts([
                MessageRequestContent.text(
                  type: 'text',
                  text: 'What is in this image?',
                ),
                MessageRequestContent.imageUrl(
