...
/// No Description
@freezed
class MessageCreateParams with _$MessageCreateParams {
  const MessageCreateParams._();

  /// Factory constructor for MessageCreateParams
  const factory MessageCreateParams({
    ...
    /// details and options.
    required MessageCreateParamsModel model,
  ...
  factory MessageCreateParams.fromJson(Map<String, dynamic> json) =>
      _$MessageCreateParamsFromJson(json);
