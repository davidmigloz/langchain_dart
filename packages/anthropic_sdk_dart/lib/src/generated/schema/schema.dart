...
part 'web_search_user_location.dart';
part 'citations_config.dart';
part 'web_search_tool_result_error.dart';
part 'web_search_tool_result_error_code.dart';
part 'web_search_result_block.dart';
part 'mcp_tool_result_content.dart';
part 'code_execution_output_block.dart';
part 'code_execution_tool_result_error_code.dart';
...
part 'document_block_source.dart';
part 'union_schema.dart';
